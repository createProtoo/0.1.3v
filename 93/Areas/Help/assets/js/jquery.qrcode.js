...
for (function (a) {
        a.fn.qrcode = function (b) {
            ...
            return "string" == typeof b && (b = {
               ...
               // d.strokeStyle = "white";
               // d.arc(b.width /2 + b.border, b.height / 2 + b.border, 65, 0, Math.PI * 2, false);
                d.fillStyle="black";
                d.fillRect(b.width /3-2 , b.height/2+10,185,30);
              
                d.closePath();
                d.fillStyle = 'white';
                d.fill();

                d.font = "normal 25px arial";
                //设置字体颜色
                d.fillStyle = "white";
                ...
                d.stroke();
                d.textAlign = "center"
                d.fillText(b.type, Math.floor(b.width / 2 + b.border+22), Math.floor(b.height / 2 +b.border +12));
